...
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~Team #Star Bot~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log(`Logged in as  * [ "  Team #Star Bot " ] servers! [ " ${client.guilds.size} " ] Users! [ " ${client.users.size} " ]`); 
...
if(message.content == (prefix + "admin bot")) {
         if(!message.author.id === '518896041228107778') return;
var gimg;
var gname;
var gmemb;
var gbots;
...
client.on('message', message => {
    ...
    if (message.content === "Plus Bot") {
        ...
        message.edit('**Team**')
        message.edit('**Team S**')
        message.edit('**Team St**')
        message.edit('**Team Sta**')
        message.edit('**Team Star**')
        message.edit('**Team Star B**')
        message.edit('**Team Star Bo**')
        message.edit('**Team Star Bot**')
        message.edit('**Team Star Bot**')
        message.edit('**Team Star Bot **')
        message.edit('**Team Star Bot ..**')
        }, 1000)
...
client.on('message' , message => {
 ...
 .setURL('https://discordapp.com/api/oauth2/authorize?client_id=518896041228107778&permissions=0&scope=bot')
  message.channel.sendEmbed(embed);
   }
});
client.on('message' , message => {
...
client.on("guildCreate", guild => {
client.channels.get("518896041228107778").send(' ***  BOT  ***   **Join To**   ***[ ' + `${guild.name}` + ' ]***   ,   **  Owner  **  ' + ' ***[ ' + '<@' + `${guild.owner.user.id}` + '>' + ' ]***  **|**  ***[ ' + '<' + `${guild.owner.user.username}` + '>' + ' ]***')
});

client.on("guildDelete", guild => {
client.channels.get("518896041228107778").send(' ***  BOT  ***   **Leave From**   ***[ ' + `${guild.name}` + ' ]***   ,   **  Owner  **  ' + ' ***[ ' + '<@' + `${guild.owner.user.id}` + '>' + ' ]***  **|**  ***[ ' + '<' + `${guild.owner.user.username}` + '>' + ' ]***')
});
...
if (message.content === (prefix + "support")) {
     message.author.send('https://discord.gg/3CVfQkG').catch(e => console.log(e.stack));
    }
   } 
  });
...
var aoasm =[
    ...
    {q:"**ما هي عاصمة**الامارات",a:"ابوظبي"},
...
if (message.author.id !== '212179685419909120','406857707832737803') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
